...
Pliki z przykładem:
- [`code/JavadocDemo.java`](code/JavadocDemo.java)
- [`code/package-info.java`](code/package-info.java)
...
```powershell
Set-Location "C:\home\gitHub\oop-concepts-java\02_OOP\src\_03_dziedziczenie\_11_javadoc"
...
javadoc -d out-docs\t11-public -sourcepath .\_11_javadoc\code -subpackages _03_dziedziczenie._11_javadoc.code -public -encoding UTF-8 -charset UTF-8 -docencoding UTF-8
```
...
```powershell
Set-Location "C:\home\gitHub\oop-concepts-java\02_OOP\src\_03_dziedziczenie"
javadoc -d out-docs\t11-protected -sourcepath .\_11_javadoc\code -subpackages _03_dziedziczenie._11_javadoc.code -protected -encoding UTF-8 -charset UTF-8 -docencoding UTF-8
```
...
```powershell
Set-Location "C:\home\gitHub\oop-concepts-java\02_OOP\src\_03_dziedziczenie"
javadoc -d out-docs\t11-private -sourcepath .\_11_javadoc\code -subpackages _03_dziedziczenie._11_javadoc.code -private -encoding UTF-8 -charset UTF-8 -docencoding UTF-8
```
...
```powershell
Set-Location "C:\home\gitHub\oop-concepts-java\02_OOP\src\_03_dziedziczenie"
javadoc -d out-docs\t11-linksource -sourcepath .\_11_javadoc\code -subpackages _03_dziedziczenie._11_javadoc.code -public -linksource -Xdoclint:all -encoding UTF-8 -charset UTF-8 -docencoding UTF-8
```
...
```powershell
Set-Location "C:\home\gitHub\oop-concepts-java\02_OOP\src\_03_dziedziczenie"
javadoc -d out-docs\t11-draft -sourcepath .\_11_javadoc\code -subpackages _03_dziedziczenie._11_javadoc.code -public -Xdoclint:none -encoding UTF-8 -charset UTF-8 -docencoding UTF-8
```
...
Uruchomienie tylko modułu `_11_javadoc`:

```powershell
Set-Location "C:\home\gitHub\oop-concepts-java\02_OOP\src\_03_dziedziczenie"
New-Item -ItemType Directory -Force -Path out | Out-Null
javac --release 21 -d out .\_11_javadoc\code\*.java
java -cp out _03_dziedziczenie._11_javadoc.code.JavadocDemo
```
