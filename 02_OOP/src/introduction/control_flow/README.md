...
javac -d . introduction/control_flow/examples/SwitchPatternDemo.java
...
```bash
# Python
python introduction/control_flow/comparison/examples.py

# C (wymaga gcc)
gcc -o examples introduction/control_flow/comparison/examples.c
./examples
```
