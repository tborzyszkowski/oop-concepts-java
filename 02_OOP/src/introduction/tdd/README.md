...
# Kompilacja Stack
javac -cp .;junit.jar -d . introduction/tdd/src/Stack.java
javac -cp .;junit.jar -d . introduction/tdd/tests/StackTest.java

# Uruchomienie
java -cp .;junit.jar org.junit.platform.console.ConsoleLauncher \
