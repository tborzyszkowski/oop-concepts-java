...
javac -d out object_lifecycle/copies/CopyDemo.java
java -cp out introduction.object_lifecycle.copies.CopyDemo

# Wzorzec Prototype
javac -d out object_lifecycle/copies/PrototypeDemo.java
java -cp out introduction.object_lifecycle.copies.PrototypeDemo

# Garbage Collector
javac -d out object_lifecycle/advanced/GcDemo.java
java -cp out introduction.object_lifecycle.advanced.GcDemo

# AutoCloseable / try-with-resources
javac -d out object_lifecycle/advanced/ResourceHolder.java
