...
Styl i struktura są spójne z modułami `_02_interfaces` i `_03_dziedziczenie`.
...
| # | Temat | Katalog |
|---|-------|---------|
| 1 | [Przestrzenie nazw i pakiety — geneza, znaczenie, konwencje](_01_przestrzenie_nazw_i_pakiety/README.md) | `_01_przestrzenie_nazw_i_pakiety/` |
| 2 | [Definiowanie pakietu i struktura fizyczna katalogów](_02_definicja_pakietu_i_struktura/README.md) | `_02_definicja_pakietu_i_struktura/` |
| 3 | [CLASSPATH, kompilacja, JARy i System Modułów](_03_classpath_i_kompilacja/README.md) | `_03_classpath_i_kompilacja/` |
| 4 | [Kontrola dostępu w obrębie pakietów](_04_kontrola_dostepu/README.md) | `_04_kontrola_dostepu/` |
| 5 | [Importy, static import i kolizje nazw](_05_importy_i_kolizje/README.md) | `_05_importy_i_kolizje/` |
| 6 | [Zadania do samodzielnego rozwiązania](_06_zadania/README.md) | `_06_zadania/` |
...
```powershell
# Z katalogu 02_OOP/src/_04_pakiety
